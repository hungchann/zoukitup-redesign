        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-stone-400 text-sm">
              <li><a href="#about" className="hover:text-zouk-gold transition-colors">Về chúng tôi</a></li>
              <li><a href="#classes" className="hover:text-zouk-gold transition-colors">Lớp học</a></li>
              <li><a href="#events" className="hover:text-zouk-gold transition-colors">Sự kiện</a></li>
              <li><a href="#faq" className="hover:text-zouk-gold transition-colors">Câu hỏi thường gặp</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-stone-400 text-sm">
              <li><a href="#" className="hover:text-zouk-gold transition-colors">Điều khoản sử dụng</a></li>
              <li><a href="#" className="hover:text-zouk-gold transition-colors">Chính sách bảo mật</a></li>
            </ul>
          </div>
        </div>
