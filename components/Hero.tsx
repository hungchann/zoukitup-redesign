  ...
  return (
    <div className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-zelda text-white font-medium mb-8 leading-tight fade-in-up delay-100">
          BRAZILIAN ZOUK <br />
          <span className="font-serif italic font-light opacity-90">& LAMBADA IN VIETNAM</span>
        </h1>
