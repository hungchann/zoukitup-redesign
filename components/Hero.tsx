  ...
  return (
    <div className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0">
        <img
          src="https://picsum.photos/seed/danceparty/1920/1080"
          alt="Zouk Dance Background"
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
        <span className="text-zouk-gold text-sm md:text-base uppercase tracking-[0.3em] mb-4 fade-in-up">
          Nghệ thuật kết nối
        </span>
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif text-white font-medium mb-8 leading-tight fade-in-up delay-100">
          Brazilian Zouk <br />
          <span className="italic font-light opacity-90">Vietnam</span>
        </h1>
        <p className="text-stone-300 text-lg md:text-xl max-w-2xl mb-10 font-light leading-relaxed fade-in-up delay-200">
          ...
          Tham gia cộng đồng Zouk lớn nhất tại Việt Nam ngay hôm nay.
        </p>
        <div className="flex flex-col md:flex-row gap-4 fade-in-up delay-300">
          <a
            href="#classes"
            className="px-8 py-3 bg-white text-black font-medium tracking-widest uppercase hover:bg-zouk-gold hover:text-white transition-all duration-300 min-w-[160px]"
          >
            Lịch học
          </a>
          <a
