              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                ...
                {dj.link && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-logo-purple-2/30 text-logo-purple-2 hover:bg-logo-purple-2 hover:text-white transition-all duration-300 text-sm uppercase tracking-widest group flex-shrink-0"
                  >
                    <Music size={16} />
